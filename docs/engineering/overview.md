...
# Overview — Runbook de Engenharia Segura e Arquitetura On-Premises

**Resumo executivo.** Consolida, num único lugar, o modelo de **arquitetura
on-premises** e as **práticas de engenharia segura** já decididas nos ADRs e
no [runbook de engenharia](../runbook/README.md). Para o detalhamento completo
(princípios, DDD, arquitetura hexagonal, SSDLC, threat modeling, testes,
CI/CD, anti-patterns), ver o **[runbook completo](secure-onprem-runbook.md)**.
A **autoridade** é sempre o ADR citado.
