...
Runbook [§18](../runbook/03-parte-iii-conectores-e-engine-pst.md#18-seleção-da-engine-pst), [§18.1](../runbook/03-parte-iii-conectores-e-engine-pst.md#181-decisão-recomendada), [§18.2](../runbook/03-parte-iii-conectores-e-engine-pst.md#182-interface-do-adapter), [§20.3](../runbook/03-parte-iii-conectores-e-engine-pst.md#203-split-simples-por-tamanho-com-aspose). Referência oficial: Aspose PST split/`SplitInto` — Apêndice F. **Plano formal da PoC (item 1 do gate): [0004-poc-plan.md](0004-poc-plan.md).** **Pendentes do gate:** relatório de PoC executado, termos de licença e parecer jurídico anexados ao PR de aprovação.
