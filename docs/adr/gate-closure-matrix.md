...
| [0003](0003-azure-sql-e-service-bus-premium.md) | Vinicius Miranda | Dev + Arquitetura/Segurança | desenho de persistência e fila durável **on-premises** (SQL Server local; sem Azure obrigatório) — *estimativa de custos Azure não se aplica* | a atribuir | proposto (reescrito — pivô on-premises) |
