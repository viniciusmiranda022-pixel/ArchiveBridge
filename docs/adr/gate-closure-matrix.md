...
| [0003](0003-azure-sql-e-service-bus-premium.md) | Vinicius Miranda | Dev + Arquitetura/Segurança | desenho de persistência e fila durável **on-premises** + [parecer de correção da fila SQL](evidence/0003-parecer-fila-sql-onprem.md) (fencing `lease_epoch`, ledger `external_operations`, anti-starvation; SQL Server local, sem Azure obrigatório) — *estimativa de custos Azure não se aplica* | Engenharia | **aceito** pelo Decision Owner em 2026-07-22 (vigência no merge do PR #14) |
...
claude/adr-0008-isolamento-onprem
| [0005](0005-libpff-validador-independente.md) | Vinicius Miranda | Jurídico (para habilitação futura) | análise de compatibilidade e licença LGPL — [análise técnica LGPL](evidence/0005-analise-lgpl-libpff.md) (parecer jurídico = requisito de habilitação futura, não do MVP) | Engenharia | **aceito** como decisão de **não inclusão no MVP** pelo Decision Owner em 2026-07-28 — capacidade opcional `LibpffIndependentValidation = BLOCKED_PENDING_EVIDENCE`, não bloqueia o MVP |
| [0006](0006-purview-adapter-ga-inicial.md) | Vinicius Miranda | responsável técnico pelo tenant | relatório de validação do Purview — [protocolo de validação](evidence/0006-plano-validacao-purview.md) (execução em tenant pendente) | a atribuir | proposto |
...
| [0006](0006-purview-adapter-ga-inicial.md) | Vinicius Miranda | responsável técnico pelo tenant | [protocolo de validação](evidence/0006-plano-validacao-purview.md): **Gate A** (validação operacional em tenant — **pendente**, obrigatório antes de produção/certificação) + **Gate B** (contrato de implementação) | a atribuir | **aceito** (arquitetural) pelo Decision Owner em 2026-07-28 — validação operacional em tenant pendente antes de produção |
claude/adr-0006-purview-adapter
...
| [0008](0008-isolamento-por-tenant-e-projeto.md) | Vinicius Miranda | Segurança/Privacidade | threat model e avaliação de dados — [threat model on-prem + avaliação de dados](evidence/0008-threat-model-avaliacao-dados.md) + [parecer técnico Seg./Priv.](evidence/0008-parecer-tecnico-seguranca-privacidade.md) (**APROVAÇÃO TÉCNICA CONDICIONAL**; assinatura institucional Seg./DPO pendente antes de produção; HA de segredos `BLOCKED_PENDING_EVIDENCE`) | Engenharia | **aceito arquiteturalmente com condições** pelo Decision Owner em 2026-07-28 — assinatura Seg./DPO pendente antes de produção; não bloqueia o início do desenvolvimento |
| [0013](0013-exportacao-ev-multiversao.md) | Vinicius Miranda | Dev + Segurança | revisão técnica do capability discovery e dos adapters — [evidência](evidence/0013-revisao-tecnica-ev.md) (publicada pelo PR #10); L1–L6 = condições de certificação; segmentação `CONDICIONAL` | Engenharia | **aceito** pelo Decision Owner em 2026-07-21 (vigência no merge deste PR) |
