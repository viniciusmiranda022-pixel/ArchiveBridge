...
| [0008](0008-isolamento-por-tenant-e-projeto.md) | Vinicius Miranda | Segurança/Privacidade | threat model e avaliação de dados — [threat model on-prem + avaliação de dados](evidence/0008-threat-model-avaliacao-dados.md) (revisão Segurança/DPO pendente) | a atribuir | proposto |
