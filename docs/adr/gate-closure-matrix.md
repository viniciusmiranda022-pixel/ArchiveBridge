...
| [0003](0003-azure-sql-e-service-bus-premium.md) | Vinicius Miranda | Dev + Arquitetura/Segurança | desenho de persistência e fila durável **on-premises** + [parecer de correção da fila SQL](evidence/0003-parecer-fila-sql-onprem.md) (SQL Server local; sem Azure obrigatório) — *estimativa de custos Azure não se aplica* | Engenharia | proposto (reescrito — pivô on-premises) |
